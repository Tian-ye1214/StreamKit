...
from pages.SAM3.SAMCode.model.memory import SimpleMaskEncoder

from pages.SAM3.SAMCode.model.sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames

from pages.SAM3.SAMCode.sam.mask_decoder import MaskDecoder, MLP
from pages.SAM3.SAMCode.sam.prompt_encoder import PromptEncoder
from pages.SAM3.SAMCode.sam.transformer import TwoWayTransformer
from pages.SAM3.SAMCode.model.data_misc import BatchedDatapoint
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _compile_all_components(self):
        ...
        from pages.SAM3.SAMCode.perflib.compile import compile_wrapper
