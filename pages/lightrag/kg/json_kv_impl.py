...
from pages.lightrag.base import (
    BaseKVStorage,
)
from pages.lightrag.utils import (
    load_json,
    logger,
    write_json,
)
from pages.lightrag.exceptions import StorageNotInitializedError
...
class JsonKVStorage(BaseKVStorage):
    ...
    async def _migrate_legacy_cache_structure(self, data: dict) -> dict:
        ...
        """
        from pages.lightrag.utils import generate_cache_key
