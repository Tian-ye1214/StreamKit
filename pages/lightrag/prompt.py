...
Current Query: {query}
######################
The `Output` should be in JSON format, with no other text before and after the JSON. In all cases, you should provide both "high_level_keywords" and "low_level_keywords". Neither field should return an empty list.
Use the same language as `Current Query`.
